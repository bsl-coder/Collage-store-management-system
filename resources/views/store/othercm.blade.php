            ...
            <div class="col-12 mt-5">
                <div style="display: none" class="card" id="form">
                    <div class="card-body" id="form">
                        ...
                        <form action="{{route('othercm.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="card-body" id="table">
                        <h2 class="bg-primary" style="width: 100%;text-align: center;color:azure">Lab 1 Other Componemts Information</h2>
                            ...
                            <table id="dataTable" class="table  datanew ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$value->model}}</td>
                                        <td>{{$value->details}}</td>
                                        <td><a href="{{route('othercm.update',$value->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="" class="text-danger"></a>
                                            <form action="{{route('othercm.delete',$value->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
