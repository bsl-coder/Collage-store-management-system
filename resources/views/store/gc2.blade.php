            ...
            <div class="col-12 mt-5">
                <div style="display: none" class="card" id="form">
                    <div class="card-body" id="form">
                        ...
                        @endif
                        <h4 class="bg-info" style="width: 100%;text-align: center;color:azure">Add Graphics Card Data</h4>
                        <form action="{{route('gc2.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="gc_id" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                @if($errors->has('gc_id'))
                    ...
                    <div class="card-body" id="table">
                        <h2 class="bg-primary" style="width: 100%;text-align: center;color:azure">Lab 2 Graphics Cards Information</h2>
                            ...
                            <table id="dataTable" class="table  datanew ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$value->model}}</td>
                                        <td>{{$value->details}}</td>
                                        <td><a href="{{route('gc2.update',$value->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="" class="text-danger"></a>
                                            <form action="{{route('gc2.delete',$value->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
