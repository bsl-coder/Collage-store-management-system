            ...
            <div class="col-12 mt-5">
                <div style="display: none" class="card" id="form">
                    <div class="card-body" id="form">
                        ...
                        <form action="{{route('ram2.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                           ...
                           <a href="{{route('ram2')}}"><button type="button" id="hide" class="btn btn-danger mt-4 pr-4 pl-4">Cancel</button></a>
                       </form>
                    </div>
                </div>

                    <div class="card-body" id="table">
                        <h2 class="bg-primary" style="width: 100%;text-align: center;color:azure">Lab 2 RAMs Information</h2>
                            ...
                            <table id="dataTable" class="table  datanew ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$value->rambus}}</td>
                                        <td>{{$value->details}}</td>
                                        <td><a href="{{route('ram2.update',$value->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="" class="text-danger"></a>
                                            <form action="{{route('ram2.delete',$value->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
