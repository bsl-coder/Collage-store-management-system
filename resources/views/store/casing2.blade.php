            ...
            <div class="col-12 mt-5">
                <div style="display: none" class="card" id="form">
                    <div class="card-body" id="form">
                        ...
                        @endif
                        <h4 class="bg-info" style="width: 100%;text-align: center;color:azure">Add Casing Data</h4>
                        <form action="{{route('casing2.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="casing_id" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                           ...
                           <a href="{{route('casing2')}}"><button type="button" id="hide" class="btn btn-danger mt-4 pr-4 pl-4">Cancel</button></a>
                       </form>
                    </div>
                </div>

                    <div class="card-body" id="table">
                        <h2 class="bg-primary" style="width: 100%;text-align: center;color:azure">Lab 2 Casings Information</h2>
                            ...
                            <table id="data" class="table  datanew ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$value->model}}</td>
                                        <td>{{$value->details}}</td>
                                        <td><a href="{{route('casing2.update',$value->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="" class="text-danger"></a>
                                            <form action="{{route('casing2.delete',$value->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
